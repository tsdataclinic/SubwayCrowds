...
stop_order_merged = pd.read_csv('scripts/data/stops.csv')
crosswalk = pd.read_csv('scripts/data/Master_crosswalk.csv')
station_to_station = pd.read_csv('scripts/data/station_to_station.csv')
...
static_schedule = pd.read_csv('scripts/data/google_transit/stop_times.txt')
trips = pd.read_csv('scripts/data/google_transit/trips.txt')
stops = pd.read_csv('scripts/data/google_transit/stops.txt')
